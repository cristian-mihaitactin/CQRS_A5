package com.ip.gateway.repository;

import com.ip.gateway.GatewayApp;
import com.ip.gateway.config.Constants;
import com.ip.gateway.config.audit.AuditEventConverter;
import com.ip.gateway.domain.PersistentAuditEvent;
...
import static com.ip.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
