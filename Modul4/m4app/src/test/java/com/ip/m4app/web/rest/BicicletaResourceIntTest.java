package com.ip.m4app.web.rest;

import com.ip.m4app.M4AppApp;
...
import com.ip.m4app.web.rest.errors.ExceptionTranslator;
...
import static com.ip.m4app.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = M4AppApp.class)
