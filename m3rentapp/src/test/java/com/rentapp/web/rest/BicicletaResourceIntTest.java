...
import com.rentapp.M3RentappApp;

import com.rentapp.domain.Bicicleta;
import com.rentapp.repository.BicicletaRepository;
import com.rentapp.service.BicicletaService;
import com.rentapp.service.dto.BicicletaDTO;
import com.rentapp.service.mapper.BicicletaMapper;
import com.rentapp.web.rest.errors.ExceptionTranslator;
...
import static com.rentapp.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = M3RentappApp.class)
public class BicicletaResourceIntTest {
    ...
    private static final LocalDate DEFAULT_DATA_RETURN = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATA_RETURN = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Bicicleta createEntity(EntityManager em) {
        Bicicleta bicicleta = new Bicicleta()
            ...
            .data_return(DEFAULT_DATA_RETURN)
    ...
    public void createBicicleta() throws Exception {
        ...
        assertThat(testBicicleta.getData_return()).isEqualTo(DEFAULT_DATA_RETURN);
    ...
    public void getAllBicicletas() throws Exception {
        ...
        restBicicletaMockMvc.perform(get("/api/bicicletas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].data_return").value(hasItem(DEFAULT_DATA_RETURN.toString())))
    ...
    public void getBicicleta() throws Exception {
        ...
        restBicicletaMockMvc.perform(get("/api/bicicletas/{id}", bicicleta.getId()))
            ...
            .andExpect(jsonPath("$.data_return").value(DEFAULT_DATA_RETURN.toString()))
    ...
    public void updateBicicleta() throws Exception {
        ...
        updatedBicicleta
            ...
            .data_return(UPDATED_DATA_RETURN)
        ...
        assertThat(testBicicleta.getData_return()).isEqualTo(UPDATED_DATA_RETURN);
