...
import ro.pip.bike.config.Constants;
import ro.pip.bike.GatewayApp;
import ro.pip.bike.domain.Authority;
import ro.pip.bike.domain.User;
import ro.pip.bike.repository.AuthorityRepository;
import ro.pip.bike.repository.UserRepository;
import ro.pip.bike.security.AuthoritiesConstants;
import ro.pip.bike.service.MailService;
import ro.pip.bike.service.dto.UserDTO;
import ro.pip.bike.web.rest.errors.ExceptionTranslator;
import ro.pip.bike.web.rest.vm.KeyAndPasswordVM;
import ro.pip.bike.web.rest.vm.ManagedUserVM;
import ro.pip.bike.service.UserService;
