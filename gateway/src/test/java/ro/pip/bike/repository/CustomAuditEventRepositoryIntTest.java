...
import ro.pip.bike.config.audit.AuditEventConverter;
import ro.pip.bike.domain.PersistentAuditEvent;
...
import static ro.pip.bike.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
