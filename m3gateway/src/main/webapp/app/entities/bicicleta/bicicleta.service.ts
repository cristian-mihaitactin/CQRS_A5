...
export class BicicletaService {
    ...
    private resourceUrl =  SERVER_API_URL + 'm3rentapp/api/bicicletas';
    ...
    private convertItemFromServer(bicicleta: Bicicleta): Bicicleta {
        ...
        copy.data_inchiriere = this.dateUtils
            .convertLocalDateFromServer(bicicleta.data_inchiriere);
        copy.data_return = this.dateUtils
            .convertLocalDateFromServer(bicicleta.data_return);
        return copy;
    }
    ...
    private convert(bicicleta: Bicicleta): Bicicleta {
        const copy: Bicicleta = Object.assign({}, bicicleta);
        copy.data_inchiriere = this.dateUtils
            .convertLocalDateToServer(bicicleta.data_inchiriere);
        copy.data_return = this.dateUtils
            .convertLocalDateToServer(bicicleta.data_return);
        return copy;
    }
}
