...
@Component({
    ...
    templateUrl: './m-1-bicicletaRented-dialog.component.html'
})
export class M1bicicletaRentedDialogComponent implements OnInit {
...
export class M1bicicletaRentedPopupComponent implements OnInit, OnDestroy {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.m1bicicletaPopupService
                    .open(M1bicicletaRentedDialogComponent as Component, params['id']);
            } else {
                this.m1bicicletaPopupService
                    .open(M1bicicletaRentedDialogComponent as Component);
            }
        });
    }
