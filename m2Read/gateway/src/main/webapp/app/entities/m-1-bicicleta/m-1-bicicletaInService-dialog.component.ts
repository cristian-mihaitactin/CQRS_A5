...
@Component({
    ...
    templateUrl: './m-1-bicicletaInService-dialog.component.html'
})
export class M1bicicletaInServiceDialogComponent implements OnInit {
...
export class M1bicicletaInServicePopupComponent implements OnInit, OnDestroy {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.m1bicicletaPopupService
                    .open(M1bicicletaInServiceDialogComponent as Component, params['id']);
            } else {
                this.m1bicicletaPopupService
                    .open(M1bicicletaInServiceDialogComponent as Component);
            }
        });
    }
