...
@Component({
    ...
    templateUrl: './m-1-bicicleta-dialog.component.html'
})
export class M1bicicletaDialogComponent implements OnInit {
...
export class M1bicicletaPopupComponent implements OnInit, OnDestroy {
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                this.m1bicicletaPopupService
                    .open(M1bicicletaDialogComponent as Component, params['id']);
            } else {
                this.m1bicicletaPopupService
                    .open(M1bicicletaDialogComponent as Component);
            }
        });
    }
