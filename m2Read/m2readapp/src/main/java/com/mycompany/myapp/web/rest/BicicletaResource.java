...
public class BicicletaResource {
    ...
    @Timed
    public ResponseEntity<BicicletaDTO> createBicicleta(@RequestBody BicicletaDTO bicicletaDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<BicicletaDTO> updateBicicleta(@RequestBody BicicletaDTO bicicletaDTO) throws URISyntaxException {
